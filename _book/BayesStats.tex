...
{\centering \includegraphics[width=0.5\linewidth]{BayesStats_files/figure-latex/dbinom-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{BayesStats_files/figure-latex/unipdf-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{BayesStats_files/figure-latex/binpostuni-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{BayesStats_files/figure-latex/dbeta-1} 
...
{\centering \includegraphics{BayesStats_files/figure-latex/effectbin-1} 
